...
# 02110-1301, USA
#
# Get propper interface
IFACE=`ifconfig | grep eth | cut -d ' ' -f 1`
# Change name of the brdige port
perl -pi -e "s/bridge_ports eth0/bridge_ports ${IFACE}/" /etc/network/interfaces
# Restart networking
